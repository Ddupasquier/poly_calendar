...
const colors = {
    ...
    "--color-theme-1-D1": commonUtils.darken(terracotta, 10),
    "--color-theme-1-L1": commonUtils.lighten(terracotta, 10),
    "--color-theme-2": jadeGreen,
    "--color-theme-2-D1": commonUtils.darken(jadeGreen, 10),
    "--color-theme-2-L1": commonUtils.lighten(jadeGreen, 10),
